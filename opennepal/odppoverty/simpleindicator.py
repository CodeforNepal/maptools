...
def convert_csv(indicatorfile, indicator, rowname, nationalvalue, outputfile):
    print('Input file: {}, \nOutput file: {}'.format(indicatorfile,
                                                     outputfile))
...
def main(args):
    ...
    outputfile = ''
    try:
        opts, args = getopt.getopt(args, 'hi:m:n:p:o:',
                                   ['indicatorfile=',
                                    'indicator=',
                                    'rowname=',
                                    'nationalvalue=',
        ...
        print('python povertyindicators.py -i <indicatorfile> -m <indicator> '
              '-n <rowname> -p <nationalvalue> -o <outputfile> ')
        sys.exit(2)
    for opt, arg in opts:
        if opt == '-h':
            print('python povertyindicators.py -i <indicatorfile> '
