...
def main(args):
    ...
    try:
        ...
        print('python set_district_geojson_properties.py -i <inputjson> -o <outputjson>')
        sys.exit(2)
    for opt, arg in opts:
        if opt == '-h':
            print('python set_district_geojson_properties.py '
                  '-i <inputjson> '
                  '-o <outputjson>')
            sys.exit()
