...
DeliveryRow = namedtuple('DeliveryRow', ['district_code', 'district_name',
                                         'sba_at_facility', 'sba_at_home',
...
def deliveries_for_district(delivery_row_tuple):
    ...
    geo_code = geoidmappings.names_to_geo_ids[
        delivery_row_tuple.district_name.title()]
    return [
        {
            'geo_code': geo_code,
            'geo_level': geo_level,
    ...
    with open(inputfile, 'r') as data, open(outputfile, 'w') as csv_out:
        ...
        district_data = [row for district_deliveries
                         ...
                         [deliveries_for_district(
                             DeliveryRow(row[COLUMNS['district_code']],
        ...
        national_row = [DeliveryRow(row[COLUMNS['district_code']],
                                    row[COLUMNS['district_name']],
                                    row[COLUMNS['sba_at_facility']],
                                    row[COLUMNS['sba_at_home']],
                                    row[COLUMNS['health_worker_at_facility']],
